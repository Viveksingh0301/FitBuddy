...
## App
st.write("# FitBuddy Web App")

st.markdown("❗❗ **Developed by Team Pathfinders** ❗❗")
...
st.markdown("We are currently developing and testing two new feature engineering strategies:")
